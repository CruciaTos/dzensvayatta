...
export const GROWMONT_CRM_PROJECT: Project = {
  ...
  body: "Growmont CRM replaces scattered spreadsheets and manual follow-ups with one app for the whole advisory team. Clients, sales, and reminders stay in sync across desktop and phone, work continues even offline, and no follow-up slips through. Advisors spend less time on admin and more time with clients.",
  stack: [
    "Works Offline",
    "Cloud Sync",
    "Role-Based Access",
